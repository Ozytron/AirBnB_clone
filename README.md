...
```bash
git clone git@github.com:Ozytron/AirBnB_clone.git
```
...
<details>
    <summary>Regina Dennis</summary>
    <ul>
    <li><a href="https://www.github.com/Seungina">Github</a></li>
    <li><a href="mailto:ReginaDennis@gmail.com@gmail.com">E-mail</a></li>
    </ul>
</details>
